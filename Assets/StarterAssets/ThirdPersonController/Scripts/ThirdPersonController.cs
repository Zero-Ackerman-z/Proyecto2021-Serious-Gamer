...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public Vector3 OffsetCamera;                              //public float dampingCoefficient = 5; // how quickly you break to a halt after you stop your input
        ...
        private void Update()
        {
            ...
            if (_mainCamera != null && head != null)
            {
                _mainCamera.transform.position = Vector3.Lerp(_mainCamera.transform.position, head.position + OffsetCamera, Time.deltaTime * 50);
            }
        ...
        void UpdateInput()
        {
            ...
            Quaternion rotate = Quaternion.LookRotation(_mainCamera.transform.forward);
            rotate.x = 0;
            rotate.z = 0;
        ...
        public void PushJump(float Force)
        {
            _input.jump = true;

            JumpHeight = _controller.velocity.magnitude * Force;
            JumpAndGravity();
        }
